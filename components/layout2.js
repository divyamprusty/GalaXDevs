...
export default function layout2() {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap -m-12">
      ...
      <img alt="blog" src="https://dummyimage.com/104x104" className="w-40 h-40 rounded-full flex-shrink-0 object-cover object-center"/>
      ...
      <div className="p-12 md:w-1/2 flex flex-col items-start">
      <img alt="blog" src="https://dummyimage.com/103x103" className="w-40 h-40 rounded-full flex-shrink-0 object-cover object-center"/>
