...
function FAQ() {
  ...
  return (
    <div>
      <div className="container mx-auto pt-16 bg-gray-100 dark:bg-gray-900">
        <div className="text-center pb-3 md:pb-10 xl:pb-20">
          <h1 className="px-2 xl:px-0 xl:text-3xl md:text-2xl text-xl font-bold text-gray-800 dark:text-white">
            Frequently Asked Questions
          </h1>
        </div>
        <div className="w-10/12 mx-auto">
          <ul>
            <li className="py-6 dark:border-gray-500 border-gray-200 border-solid border-b">
              <div className="flex justify-between items-center">
                <h3 className="text-gray-800 dark:text-gray-400 text-base  md:text-xl  xl:text-2xl w-10/12">
              ...
              {question === 0 && (
                <p className="pt-2 md:pt-3 dark:text-gray-400 dark:bg-gray-900 lg:pt-5 text-gray-800 bg-gray-100 text-sm md:text-base  xl:text-lg rounded-b-lg">
