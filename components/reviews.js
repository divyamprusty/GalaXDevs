          ...
          <div className="flex flex-wrap -m-4">
            <div className="p-4 md:w-1/2 w-full" data-aos="flip-up">
              <div className="h-full bg-gray-100 dark:bg-gray-800 p-8 rounded">
                ...
                <p className="leading-relaxed mb-6 dark:text-gray-400">
                  {" "}
                  I started using R2D2 since last year and it has continued to
                  fasciante me since then. From assisting the household tasks to
                  keeping me company, it has excelled in every possible aspect.
                </p>
